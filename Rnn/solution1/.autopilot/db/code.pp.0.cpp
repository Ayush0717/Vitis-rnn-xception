...
static const float rnn_Wx[1][8] = { 0.671069f, 0.064521f, 0.103900f, -0.272255f, -0.768570f, 0.929975f, 0.174642f, -0.162471f };
static const float rnn_Wh[8][8] = { -0.319012f, -0.194374f, 0.178049f, -0.826248f, 0.485042f, 0.559405f, 0.193241f, 0.031141f, -0.174028f, 0.154049f, 0.203851f, 0.373613f, 0.138969f, -0.592684f, -0.555464f, 0.622364f, 1.041727f, 0.082165f, 0.585501f, 0.040320f, 0.064008f, 0.671474f, 0.007743f, 0.136948f, -0.638133f, 0.552718f, 0.788529f, 0.320591f, 0.178437f, -0.136658f, -0.168709f, 0.126493f, -0.200747f, 0.787987f, -0.288698f, -0.017325f, -0.229260f, 0.191803f, 0.457214f, 0.434840f, -0.063700f, -0.011319f, -0.393590f, -0.359454f, -0.721916f, 0.221086f, -0.884363f, -0.501146f, -0.145671f, -0.523427f, 0.270745f, -0.300928f, -0.355359f, 0.382459f, 0.286441f, 0.637306f, 0.522172f, -0.225660f, 0.421676f, -0.442735f, -0.005180f, -0.372596f, 0.447452f, -0.088324f };
static const float rnn_b[8] = { -0.111417f, -0.152056f, -0.281341f, 0.410177f, -0.120936f, 0.204070f, -0.443451f, -0.414793f };
static const float dens_W[8][1] = { 0.120271f, -0.065425f, -0.779206f, 0.931289f, -1.043847f, 0.434074f, -1.179272f, -0.943124f };
static const float dens_b[1] = { 0.299917f };
# 2 "code.cpp" 2
...
__attribute__((sdx_kernel("rnn_forward", 0))) void rnn_forward(
    const float input_sequence[4][1],
    float output_sequence[4][1])
{
#line 16 "D:/work_station/es_proj/es_proj/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=rnn_forward
# 12 "code.cpp"
...
#pragma HLS ARRAY_PARTITION variable = temp_hidden complete dim = 1
 ...
 VITIS_LOOP_24_1: for (int t = 0; t < 4; t++)
    {
        float input_t = input_sequence[t][0];


        VITIS_LOOP_29_2: for (int h = 0; h < 8; h++)
        {
#pragma HLS UNROLL
 float sum = rnn_b[h];
            ...
            VITIS_LOOP_36_3: for (int i = 0; i < 8; i++)
            {
        ...
        VITIS_LOOP_45_4: for (int h = 0; h < 8; h++)
        {
            hidden_state[h] = temp_hidden[h];
        }


        VITIS_LOOP_51_5: for (int o = 0; o < 1; o++)
        {
#pragma HLS UNROLL
 float sum = dens_b[o];
            VITIS_LOOP_55_6: for (int h = 0; h < 8; h++)
            {
