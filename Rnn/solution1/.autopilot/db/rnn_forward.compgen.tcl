...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 49 \
			corename rnn_forward_CONTROL_BUS_axilite \
			name rnn_forward_CONTROL_BUS_s_axi \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler rnn_forward_CONTROL_BUS_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
set InstName rnn_forward_flow_control_loop_pipe_U
set CompName rnn_forward_flow_control_loop_pipe
